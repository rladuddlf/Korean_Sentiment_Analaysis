...
os.chdir("C:\\Users\\USER\\PycharmProjects\\Sentimental-Analysis-master\\Sentimental-Analysis-master\\Word2Vec\\Movie_rating_data")
...
model.most_similar('슬프다/Adjective',topn = 20)  ## topn = len(model.wv.vocab)
