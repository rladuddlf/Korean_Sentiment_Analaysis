...
train_X_ = W2V.Convert2Vec("./Word2Vec/Word2vec3.model",train_X)  ## import word2vec model where you have trained before
test_Y_ = W2V.One_hot(test_Y)  ## Convert to One-hot
test_X_ = W2V.Convert2Vec("./Word2Vec/Word2vec3.model",test_X)  ## import word2vec model where you have trained before
...
modelName = "./Bidirectional_LSTM/BiLSTM_model3.ckpt"
...
with tf.Session(config = config) as sess:
    ...
    df.to_csv("./Bidirectional_LSTM/loss_accuracy3.csv", sep =",", index=False)
